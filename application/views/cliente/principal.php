	...
	<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
		...
		<div class="row principal" >
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 starmenu">
				...
				<hr>
				<h4>Preço</h4>
				<input id="ex13" type="text" data-slider-ticks="[0,200, 400, 600, 800]" data-slider-ticks-snap-bounds="30" data-slider-ticks-labels='["$0", "$200", "$400", "$600", "$800"]'/>
				<button class="btn btn-primary" style="float:right" type="button">Buscar</button>
			</div>
