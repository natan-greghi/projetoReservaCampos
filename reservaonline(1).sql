...
--
-- Host: 127.0.0.1
-- Generation Time: 30-Nov-2015 às 17:51
...
--
-- Estrutura da tabela `ccredito`
--

CREATE TABLE IF NOT EXISTS `ccredito` (
...
--
-- Extraindo dados da tabela `ccredito`
--

INSERT INTO `ccredito` (`idcCredito`, `bandeira`, `img`) VALUES
(1, 'Visa', 'img/credito/visa.png'),
(2, 'Mastercard', 'img/credito/master.png'),
(3, 'Elo', 'img/credito/elo.png');
...
INSERT INTO `cliente` (`idCliente`, `nome`, `email`, `senha`, `telefone`, `uf`, `cidade`, `cpf`) VALUES
(1, 'Natan Silva Greghi', 'natan.greghi@gmail.com', '123teste', '1236623349', 'sp', 'Campos do Jordão', '39874683864');

-- --------------------------------------------------------

--
-- Estrutura da tabela `hotelpousada`
--

CREATE TABLE IF NOT EXISTS `hotelpousada` (
  `idHotelPousada` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) NOT NULL,
  `categoria` tinyint(1) NOT NULL,
  `classificacao` smallint(6) DEFAULT NULL,
  `endereco_fisico` varchar(100) NOT NULL,
  `latitude` double NOT NULL,
  `longitude` double NOT NULL,
  `telefone` varchar(11) NOT NULL,
  `link_site` varchar(40) NOT NULL,
  `imgHotel` varchar(45) NOT NULL,
  PRIMARY KEY (`idHotelPousada`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;

--
-- Extraindo dados da tabela `hotelpousada`
--

INSERT INTO `hotelpousada` (`idHotelPousada`, `nome`, `categoria`, `classificacao`, `endereco_fisico`, `latitude`, `longitude`, `telefone`, `link_site`, `imgHotel`) VALUES
(3, 'Grande Hotel', 1, 5, 'Av. Principal, Jaguaribe', -22.730957, -45.5854303, '123668-6000', 'grandehotelsenac.com', 'logohotel.png'),
(4, 'Hotel Vila Inglesa', 1, 3, 'Rua 5, Alto da Vila Inglesa', -22.745662, -45.5713017, '1236666666', 'hotelvilainglesa.com', 'logohotel.png'),
(6, 'Pousada Luis XV', 2, NULL, 'Rua Djalma Forjaz, 263, Capivari', -22.7198383, -45.5676208, '1236555555', 'www.pousadaluisxv.com', 'logopousada.png');

-- --------------------------------------------------------

--
-- Estrutura da tabela `hotelpousadaservicos`
--

CREATE TABLE IF NOT EXISTS `hotelpousadaservicos` (
  `hotelPousada_idHotelPousada` int(11) NOT NULL,
  `servicos_idservicos` int(11) NOT NULL,
  PRIMARY KEY (`hotelPousada_idHotelPousada`,`servicos_idservicos`),
  KEY `fk_hotelPousada_has_servicos_servicos1_idx` (`servicos_idservicos`),
  KEY `fk_hotelPousada_has_servicos_hotelPousada_idx` (`hotelPousada_idHotelPousada`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `hotelpousadaservicos`
--

INSERT INTO `hotelpousadaservicos` (`hotelPousada_idHotelPousada`, `servicos_idservicos`) VALUES
(3, 1),
(4, 1),
(3, 2),
(4, 3);
...
--
-- Estrutura da tabela `hotelpousada_has_ccredito`
--

CREATE TABLE IF NOT EXISTS `hotelpousada_has_ccredito` (
  `hotelPousada_idHotelPousada` int(11) NOT NULL,
  `cCredito_idcCredito` int(11) NOT NULL,
  PRIMARY KEY (`hotelPousada_idHotelPousada`,`cCredito_idcCredito`),
  KEY `fk_hotelPousada_has_cCredito_cCredito1_idx` (`cCredito_idcCredito`),
  KEY `fk_hotelPousada_has_cCredito_hotelPousada1_idx` (`hotelPousada_idHotelPousada`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `hotelpousada_has_ccredito`
--

INSERT INTO `hotelpousada_has_ccredito` (`hotelPousada_idHotelPousada`, `cCredito_idcCredito`) VALUES
(3, 1),
(3, 2),
(3, 3);
...
CREATE TABLE IF NOT EXISTS `imagens` (
  ...
  `hotelPousada_idHotelPousada` int(11) NOT NULL,
  PRIMARY KEY (`idimagens`,`hotelPousada_idHotelPousada`),
  KEY `fk_imagens_hotelPousada1_idx` (`hotelPousada_idHotelPousada`)
...
INSERT INTO `imagens` (`idimagens`, `imagem`, `hotelPousada_idHotelPousada`) VALUES
(1, '1.png', 3),
(2, 'img/grandeHotel/2.png', 3),
(3, 'img/grandeHotel/3.png', 3),
(4, 'img/grandeHotel/4.png', 3);
...
CREATE TABLE IF NOT EXISTS `quartos` (
  ...
  `nPessoas` smallint(6) NOT NULL,
  `imagem` varchar(100) NOT NULL,
  `precoPromo` double NOT NULL,
  `precoFixo` double NOT NULL,
  `hotelPousada_idHotelPousada` int(11) NOT NULL,
  `tipoQuarto_idtipoQuarto` int(11) NOT NULL,
  PRIMARY KEY (`idquartos`,`hotelPousada_idHotelPousada`,`tipoQuarto_idtipoQuarto`),
  KEY `fk_quartos_hotelPousada1_idx` (`hotelPousada_idHotelPousada`),
  KEY `fk_quartos_tipoQuarto1_idx` (`tipoQuarto_idtipoQuarto`)
...
INSERT INTO `quartos` (`idquartos`, `nome`, `nPessoas`, `imagem`, `precoPromo`, `precoFixo`, `hotelPousada_idHotelPousada`, `tipoQuarto_idtipoQuarto`) VALUES
(1, 'Quarto Deluxe Premium', 3, 'img/grandeHotel/quarto1.png', 250, 500, 3, 3),
(2, 'Quarto Farofa', 1, 'img/grandeHotel/quarto2.png', 240, 500, 3, 1),
(3, 'Quarto luxo', 2, 'luxo.png', 300, 500, 4, 2),
(4, 'Quarto pobrão', 10, 'pobre.png', 60, 80, 4, 1),
(5, 'quarto fantasia', 15, 'orgia.png', 600, 800, 6, 3);
...
CREATE TABLE IF NOT EXISTS `reservas` (
  ...
  `quartos_hotelPousada_idHotelPousada` int(11) NOT NULL,
  `quartos_tipoQuarto_idtipoQuarto` int(11) NOT NULL,
  `vendas_idvendas` int(11) NOT NULL,
  `dataInicio` date NOT NULL,
  `dataFim` date NOT NULL,
  PRIMARY KEY (`quartos_idquartos`,`quartos_hotelPousada_idHotelPousada`,`quartos_tipoQuarto_idtipoQuarto`,`vendas_idvendas`),
  KEY `fk_quartos_has_vendas_vendas1_idx` (`vendas_idvendas`),
  KEY `fk_quartos_has_vendas_quartos1_idx` (`quartos_idquartos`,`quartos_hotelPousada_idHotelPousada`,`quartos_tipoQuarto_idtipoQuarto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `reservas` (`quartos_idquartos`, `quartos_hotelPousada_idHotelPousada`, `quartos_tipoQuarto_idtipoQuarto`, `vendas_idvendas`, `dataInicio`, `dataFim`) VALUES
(1, 3, 3, 1, '2015-10-23', '2015-10-25');
...
INSERT INTO `servicos` (`idservicos`, `nome`, `img`) VALUES
(1, 'Wifi', 'wifi.png'),
(2, 'Café da Manha', 'cafe.png'),
(3, 'Concierge', 'concierge.png');
...
INSERT INTO `tipoquarto` (`idtipoQuarto`, `nome`) VALUES
(1, 'Quarto Individual'),
(2, 'Quarto Duplo'),
(3, 'Quarto Família'),
(4, 'Suite Master');
...
INSERT INTO `vendas` (`idvendas`, `status`, `dataVendas`, `Cliente_idCliente`) VALUES
(1, 1, '2015-10-23', 1);
...
--
-- Limitadores para a tabela `hotelpousadaservicos`
--
ALTER TABLE `hotelpousadaservicos`
  ADD CONSTRAINT `fk_hotelPousada_has_servicos_hotelPousada` FOREIGN KEY (`hotelPousada_idHotelPousada`) REFERENCES `hotelpousada` (`idHotelPousada`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hotelPousada_has_servicos_servicos1` FOREIGN KEY (`servicos_idservicos`) REFERENCES `servicos` (`idservicos`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `hotelpousada_has_ccredito`
--
ALTER TABLE `hotelpousada_has_ccredito`
  ADD CONSTRAINT `fk_hotelPousada_has_cCredito_cCredito1` FOREIGN KEY (`cCredito_idcCredito`) REFERENCES `ccredito` (`idcCredito`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_hotelPousada_has_cCredito_hotelPousada1` FOREIGN KEY (`hotelPousada_idHotelPousada`) REFERENCES `hotelpousada` (`idHotelPousada`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `imagens`
--
ALTER TABLE `imagens`
  ADD CONSTRAINT `fk_imagens_hotelPousada1` FOREIGN KEY (`hotelPousada_idHotelPousada`) REFERENCES `hotelpousada` (`idHotelPousada`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `quartos`
--
ALTER TABLE `quartos`
  ADD CONSTRAINT `fk_quartos_hotelPousada1` FOREIGN KEY (`hotelPousada_idHotelPousada`) REFERENCES `hotelpousada` (`idHotelPousada`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_quartos_tipoQuarto1` FOREIGN KEY (`tipoQuarto_idtipoQuarto`) REFERENCES `tipoquarto` (`idtipoQuarto`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `reservas`
--
ALTER TABLE `reservas`
  ADD CONSTRAINT `fk_quartos_has_vendas_quartos1` FOREIGN KEY (`quartos_idquartos`, `quartos_hotelPousada_idHotelPousada`, `quartos_tipoQuarto_idtipoQuarto`) REFERENCES `quartos` (`idquartos`, `hotelPousada_idHotelPousada`, `tipoQuarto_idtipoQuarto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_quartos_has_vendas_vendas1` FOREIGN KEY (`vendas_idvendas`) REFERENCES `vendas` (`idvendas`) ON DELETE NO ACTION ON UPDATE NO ACTION;
